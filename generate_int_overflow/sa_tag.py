...
class Tag(enum.Enum):
    ...
    BODY = 1
    # Integer calculate that requires control flow analysis to prove not overflowed
    INTCALCFLOW_COND_SAFE = 2
    # Integer calculate that requires control flow analysis to prove overflowed
    INTCALCFLOW_COND_UNSAFE = 3
    # Integer calculate that is provably not overflowed even without control flow
    INTCALCFLOW_TAUT_SAFE = 4
    # Integer calculate that is provably not overflowed even without control flow
    INTCALCFLOW_TAUT_UNSAFE = 5
